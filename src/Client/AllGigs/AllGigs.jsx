        ...
        <>
            ...
            <div className="relative w-5/6 mt-16 flex min-w-0 mb-6 break-words rounded-2xl bg-clip-border m-auto p-auto">
                ...
                <form class="flex items-center w-full ml-5">
                    ...
                    <button type="button" class="p-2.5 ml-2 text-sm font-medium cursor-default text-white bg-blue-700 rounded-lg border border-blue-700 dark:bg-blue-600"><svg class="w-4 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></button>
                </form>
            </div>
