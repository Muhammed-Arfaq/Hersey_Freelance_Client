                ...
                <div class="bg-white rounded-lg shadow-xl pb-8">
                    ...
                    <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                        <div class="flex items-center space-x-4 mt-2">
                            ...
                            <button class="flex items-center bg-gradient-to-r from-fuchsia-800 to-indigo-900 text-white px-4 py-2 rounded-lg text-sm space-x-2 transition duration-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                    <div class="w-full h-fit flex flex-col 2xl:w-1/3 sticky top-0">
                        ...
                        <div class="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                            <h4 class="text-xl text-gray-900 font-bold">Reserved Gigs</h4>
                    ...
                    <div class="flex flex-col w-full 2xl:w-2/3">
                        <div className="relative h-screen flex flex-col min-w-0 mb-6 break-words bg-gray-50 rounded-2xl bg-clip-border border-0 shadow-2xl mt-5">
                            <h1 className="flex py-5 ml-8 font-bold text-lg text-gray-800">
                                Favourite Vendor
                            </h1>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="flex-auto justify-evenly">
                                                    ...
                                                    <div class="flex space-x-2 text-sm font-medium justify-start mt-3">
                                                        <button class="transition ease-in duration-300 inline-flex items-center text-sm font-medium mb-2 md:mb-0 bg-gradient-to-r from-fuchsia-800 to-indigo-900 px-5 py-2 hover:shadow-lg tracking-wider text-white rounded-lg hover:bg-gray-900 ">
                                                            <span>View</span>
                                                        </button>
                                                    </div>
                                                </div>
